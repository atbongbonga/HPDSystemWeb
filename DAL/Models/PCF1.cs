...
namespace DAL.Models
{
    ...
    public partial class PCF1
    {
        ...
        public Nullable<int> COBranch { get; set; }
        public Nullable<int> DepByBranch { get; set; }
        public string BankIP { get; set; }
        public string ARIP { get; set; }
        public Nullable<System.DateTime> BillDepDt { get; set; }
        public Nullable<decimal> OrigAmt { get; set; }
        public Nullable<System.DateTime> DMPostDt { get; set; }
        public Nullable<System.DateTime> Replenishdate { get; set; }
        public string ATCCode { get; set; }
        public Nullable<decimal> ATCRate { get; set; }
        public Nullable<int> LinkLn { get; set; }
        public Nullable<int> SAPLn { get; set; }
    }
}
